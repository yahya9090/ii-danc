...
Slider {
    ...
    property real trackWidth: wavy ? 6 : configuration
    readonly property real effectiveTrackWidth: thickFill ? 18 : trackWidth
    ...
    property real handleHeight: wavy ? 24 : (configuration === StyledSlider.Configuration.X0) ? 14 : Math.max(33, trackWidth + 9)
    ...
    property real waveAmplitudeMultiplier: root.thickFill ? 1.2 : 0.5
    ...
    background: Item {
        ...
        Repeater {
            ...
            Loader {
                ...
                height: root.effectiveTrackWidth
                active: !root.wavy
        ...
        Repeater {
            ...
            Loader {
                ...
                sourceComponent: WavyLine {
                    ...
                    fullLength: root.effectiveDraggingWidth
                    color: root.highlightColor
                    amplitudeMultiplier: root.waveAmplitudeMultiplier
                    width: parent.width
                    height: root.effectiveTrackWidth * 6
                    lineWidth: root.thickFill ? 4 : 3.45 // 15% thicker than 3
                    Connections {
                        target: root
