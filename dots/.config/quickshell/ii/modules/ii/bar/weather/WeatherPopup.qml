...
StyledPopup {
    ...
    contentItem: ColumnLayout {
        ...
        HeroCard {
            ...
            margins: 20
            iconSize: 100
            icon: (Weather.data && Icons.getWeatherIcon(Weather.data.wCode)) ? Icons.getWeatherIcon(Weather.data.wCode) : ""
            pillText: (Weather.data && Weather.data.city) ? Weather.data.city : "--"
            pillIcon: (Weather.data && Weather.data.city) ? "location_on" : ""
            title: (Weather.data && Weather.data.temp) ? Weather.data.temp : "--"
            subtitle: (Weather.data && Weather.data.wDesc) ? Weather.data.wDesc : "--"
        }
