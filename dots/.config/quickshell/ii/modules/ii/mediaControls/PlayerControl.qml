...
Item { // Player instance
    ...
    Rectangle { // Background
        ...
        Loader {
            id: contentLoader
            anchors.fill: parent
            sourceComponent: root.showLyrics ? lyricsView : controlsView
                    ...
                    ColumnLayout { // Info & controls
                        ...
                        Item {
                            ...
                            RowLayout {
                                ...
                                Item {
                                    ...
                                    Loader {
                                        ...
                                        sourceComponent: StyledSlider { 
                                            ...
                                            value: StringUtils.normalizeTime(root.player?.length) > 0 ? (StringUtils.normalizeTime(root.player?.position) / StringUtils.normalizeTime(root.player?.length)) : 0
                                            onMoved: {
                                ...
                                TrackChangeButton {
                                    iconName: "lyrics"
                                    downAction: () => root.showLyrics = true
                                }

                                TrackChangeButton {
                                    iconName: "keep"
                                    buttonSize: 18
                                    fill: MprisController.pinnedPlayer == root.player
                                    downAction: () => {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            layer.effect: OpacityMask {
                                maskSource: Rectangle {
                                    width: artBackgroundLyrics.width
                                    height: artBackgroundLyrics.height
                                    radius: artBackgroundLyrics.radius
                                }
                            }
                        ...
                        Item {
                            ...
                            FadeLoader {
                                ...
                                sourceComponent: LyricsSyllable {
                                    anchors.fill: parent
                                    largeFontSize: Appearance.font.pixelSize.large
                                    activeColor: blendedColors.colPrimary
                                    preferredHighlightBegin: parent.height / 2 - 30
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            TrackChangeButton {
                                iconName: "lyrics"
                                downAction: () => root.showLyrics = false
                            }
                        }

                        Item {
                            Layout.fillWidth: true
                            implicitHeight: trackTimeLyrics.implicitHeight + sliderRowLyrics.implicitHeight + 5
