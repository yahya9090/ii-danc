...
ContentPage {  
    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ContentSubsection {
                title: Translation.tr("Translator (Left Sidebar)")
                Layout.fillWidth: false
            ...
            ContentSubsection {
                title: Translation.tr("Media player (Left Sidebar)")
                Layout.fillWidth: false

                ConfigSelectionArray {  
                    currentValue: Config.options.policies.media  
                    onSelected: newValue => {  
                        Config.options.policies.media = newValue;  
                    }  
                    options: [  
                        {  
                            displayName: Translation.tr("No"),  
