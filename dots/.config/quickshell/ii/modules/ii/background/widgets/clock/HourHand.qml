...
Item {
    ...
    property real handLength: 72 * sizeMultiplier
    property real handWidth: 20 * sizeMultiplier
    ...
    Rectangle {
        ...
        x: (parent.width - root.handWidth) / 2 - 15 * (root.style === "classic") * root.sizeMultiplier
        width: root.handLength
        height: root.style === "classic" ? 8 * root.sizeMultiplier : root.handWidth
        ...
        border.width: 4 * root.sizeMultiplier
