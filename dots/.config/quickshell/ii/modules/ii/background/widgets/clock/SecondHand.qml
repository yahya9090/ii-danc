...
Item {
    ...
    property real handWidth: 2 * sizeMultiplier
    property real handLength: 95 * sizeMultiplier
    property real dotSize: 20 * sizeMultiplier
    ...
    Rectangle {
        anchors {
            ...
            leftMargin: (10 * root.sizeMultiplier) + (root.style === "dot" ? root.dotSize : 0)
        }
    ...
    FadeLoader {
        ...
        Rectangle {
            anchors {
                left: parent.left
                verticalCenter: parent.verticalCenter
                leftMargin: 40 * root.sizeMultiplier
            }
            implicitWidth: root.style === "classic" ? 14 * root.sizeMultiplier : 0
