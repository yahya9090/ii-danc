...
MouseArea {
    ...
    implicitHeight: {
        if (Config.options.battery.style === "android16") return (14 * 2) + 12;
        if (Config.options.battery.style === "oneui") return oneuiBattery.implicitHeight + 12;
        return batteryContainer.height + 12;
    }
        ...
        textMask: Item {
            ...
            ColumnLayout {
                ...
                MaterialSymbol {
                    ...
                    fill: 1
                    text: root.isCharging ? "bolt" : "battery_android_full"
