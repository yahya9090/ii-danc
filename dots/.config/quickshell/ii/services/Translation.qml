...
Singleton {
    ...
    TranslationReader {
        ...
        availableLanguagesList: root.availableLanguages
    ...
    TranslationReader {
        ...
        translationsDir: root.generatedTranslationsDir
        languageCode: root.languageCode
        availableLanguagesList: root.availableGeneratedLanguages
        onContentLoaded: (data) => {
    ...
    component TranslationReader: FileView {
        ...
        property var availableLanguagesList: []
        signal contentLoaded(var data)

        function reread() { // Proper reload in case the file was incorrect before
            if (!languageCode || !availableLanguagesList || (availableLanguagesList.length > 0 && !availableLanguagesList.includes(languageCode))) {
